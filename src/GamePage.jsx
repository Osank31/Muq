        ...
        const detectHands = () => {
            ...
            const detect = async () => {
                if (modelRef.current && videoRef.current && videoRef.current.readyState === 4) {
                    ...
                    ctx.stroke();
                    gameCtx.drawImage(roomRef.current,
                        0,
                        0,
                        gameRef.current.width,
                        gameRef.current.height
                    ...
                    if (predictions.length > 0) {
                        ...
                        // console.log(camHandCoordinatesToGameHandCoordinates(
                        //     predictions[0].keypoints[12].x,
                        //     predictions[0].keypoints[12].y,
                        //     [canvasRef.current.width, canvasRef.current.height],
                        //     [gameRef.current.width, gameRef.current.height]
                        // ))
                        ...
                        console.log([incenter_x, incenter_y]);
